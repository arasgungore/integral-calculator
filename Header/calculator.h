...
// header which contains methods to parse and calculate the string expression

// expression struct declaration
typedef struct {
...
// main function which parses and calculates the expression and returns the calculated result of the expression
long double parse(Expression *expr, const char variable, const long double value) {
